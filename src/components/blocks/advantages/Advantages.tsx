    ...
    <Tabs>
      <>
        <Tab header="Science">
          <div className={style['advantage']}>
            <div className={style['advantage__text']}>
              ...
              that will look to the beginning of time and to hunt for the
              unobserved formation of the first galaxies, as well as to look
              inside dust clouds where stars and planetary systems are forming
              today.
              <br />
              <br />
        ...
        <Tab header="Human">
          <div className={style['advantage']}>
            <div className={style['advantage__text']}>
              Rotational crews have been living in low Earth orbit continuously
              aboard the International Space Station since 2000. Located about
              250 miles above Earth, the space station is a full-time
              microgravity laboratory. On behalf of researchers worldwide,
              station crews conduct experiments only possible in the unique
              conditions of space, observe Earth as a system, and test new
              technologies that ultimately will help send humans far beyond
              Earth.
              <br />
              <br />
              ...
              Moon and back to Earth to validate the Space Launch System rocket,
              Orion spacecraft, and other key systems. Artemis II will be the
              first flight test with astronauts to validate crew life support
              systems, and Artemis III will mark the beginning of humanity’s
